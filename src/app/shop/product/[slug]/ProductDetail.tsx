...
/**
 * Partie interactive de la fiche produit.
 * Les donnees sont chargees cote serveur (voir page.tsx) puis passees ici :
 * le texte est ainsi present dans le HTML, donc lisible par Google.
 */
export default function ProductDetail({
  ...
  // Suivi Meta Pixel : une fois la fiche affichee.
  useEffect(() => {
    pixel.viewContent({
