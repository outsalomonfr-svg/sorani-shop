...
const soraniDoux: ThemePreset = {
  ...
  preview: { primary: '#3845AD', accent: '#E8DCC8', background: '#FAF6EF' },
  recommended: true,
  apply: (s) => ({
    ...s,
    colors: {
    ...
    sectionStyles: {
      ...
      story: { bgColor: '#3845AD', textColor: '#FAF6EF', padding: 'spacious' },
      ...
      newsletter: { bgColor: '#3845AD', textColor: '#FAF6EF', padding: 'spacious' },
    },
  }),
};
...
const sorani: ThemePreset = {
  ...
  preview: { primary: '#3845AD', accent: '#BEE9E8', background: '#FFFFFF' },
  apply: (s) => ({
    ...s,
    colors: {
      primary: '#3845AD',
